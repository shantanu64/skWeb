    ...
    return (
        <div>
            ...
            <div
                ...
                className="mx-6 md:mx-14 rounded-3xl  md:rounded-br-heroRadius mt-14"
            >
                            ...
                            <div className="flex flex-col items-center mr-20">
                                <div className="flex items-center">
                                    ...
                                    <div className="flex flex-col ml-2">
                                        ...
                                        <p className="m-0 font-sans mt-0.8" style={{ color: 'white' }}>{data.location}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col items-center mr-20">
                                <div className="flex items-center">
                                    ...
                                    <div className="flex flex-col ml-2">
                                        ...
                                        <p className="m-0 font-sans mt-0.8" style={{ color: 'white' }}>{data.Department}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-col items-center mr-20">
                                <div className="flex items-center">
                                    ...
                                    <div className="flex flex-col ml-2">
                                        ...
                                        <p className="m-0 font-sans mt-0.8" style={{ color: 'white', whiteSpace: 'nowrap' }}>{data.salary}</p>
