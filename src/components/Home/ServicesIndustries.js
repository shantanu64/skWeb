  ...
  return (
    <div className="bg-headGreen h-max py-4">
      ...
      <div className="w-full flex md:flex-col md:flex-col-reverse lg:flex-col lg:flex-col-reverse md:gap-4 lg:gap-4 xl:gap-0 xl:flex-row my-10">
        <div className="lg:w-full xl:w-full flex flex-wrap justify-center gap-5">
          <div className="w-28 md:w- lg:w-40 xl:w-48 rounded-lg shadow-xl  bg-navGreenCol flex flex-col justify-center text-center gap-4">
          ...
          <div className="w-28 md:w-28 lg:w-40 xl:w-48 rounded-lg shadow-xl  bg-navGreenCol flex flex-col justify-center text-center gap-4">
            <i className="text-heroYellow">
        ...
        <div className="mx-auto lg:w-3/4 h-full flex flex-col justify-center relative ">
          ...
          <img src={ServicesProducts2} style={{ height: "250px", margin: "65px " }} className="absolute md:h-32 lg:h-40 xl:h-52 rounded-full md:left-[72px] lg:left-[100px] xl:top-[128px] xl:left-[108px]" />
